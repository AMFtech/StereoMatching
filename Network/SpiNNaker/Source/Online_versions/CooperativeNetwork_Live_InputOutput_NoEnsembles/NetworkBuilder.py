...
def createNetwork():
    ...
    print "\t Creating {0} Neural Populations...".format(numberOfPopulations)
...
#     testPopr = Frontend.Population(4, Frontend.SpikeSourceArray, {'spike_times':[1000.0]}, Line, label="testr") 
