...
simulationTime = 30000.0       # Total simulation time
...
wOutToOutInh = -60.0    # Defines the synaptic weight between individual output neurons which inhibit themselves according to the physical constraints of objects
