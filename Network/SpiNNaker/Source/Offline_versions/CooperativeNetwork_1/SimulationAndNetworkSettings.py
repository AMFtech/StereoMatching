...
dimensionRetinaY = 80       # Defines the dimension of the y-axis of the input spikes from the retina sensor
minDisparity = 0            # Defines the minimum detectable disparity
maxDisparity = 27           # Defines the maximum detectable disparity
...
retLeftSpikes = load(open('../src/realInput/retinaLeft_50x80_hand25.p', 'rb'))
retRightSpikes = load(open('../src/realInput/retinaRight_50x80_hand25.p', 'rb'))
