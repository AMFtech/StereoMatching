...
if __name__ == '__main__':
  ...
  a1, a2, a3 = (0.0, 0.7, 0.7)
  b1, b2, b3 = (0.7, 0.0, 0.7)
  r = 1.0  
  
  xf = lambda t: c1 + r*(cos(2*pi/om * t)*a1 + sin(2*pi/om * t)*b1)
  zf = lambda t: c2 + r*(cos(2*pi/om * t)*a2 + sin(2*pi/om * t)*b2)
  yf = lambda t: c3 + r*(cos(2*pi/om * t)*a3 + sin(2*pi/om * t)*b3)
...
#   print shape(xf(T)),shape(yf(T)),shape(zf(T))
  ...
  eventsFile = open('../src/realInput/artificial_events.dat', 'w')
