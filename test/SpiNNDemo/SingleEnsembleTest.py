...
ExternalDevices.activate_live_output_for(inh_left, database_notify_host="localhost",database_notify_port_num=19996, board_address='10.162.177.122')
ExternalDevices.activate_live_output_for(collector, database_notify_host="localhost",database_notify_port_num=19996, board_address='10.162.blabla7.7')
ExternalDevices.activate_live_output_for(inh_right, database_notify_host="localhost",database_notify_port_num=19996, board_address='10.162.177.122')
