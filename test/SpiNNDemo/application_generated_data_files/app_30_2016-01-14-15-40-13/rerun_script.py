...
placements = dict()
boot_port_num = None
placement_to_app_data_files = {(0, 0, 2, 'c0'): ['10.162.177.122_appData_0_0_2.dat'], (0, 0, 1, 'i0'): ['10.162.177.122_appData_0_0_1.dat'], (0, 0, 4, 'LiveSpikeReceiver'): ['10.162.177.122_appData_0_0_4.dat'], (0, 0, 3, 'c0'): ['10.162.177.122_appData_0_0_3.dat']}
verify = False
...
processor_to_app_data_base_address = {(0, 0, 2, 'c0'): {'start_address': 1612972052, 'memory_used': 197632, 'memory_written': 17552}, (0, 0, 3, 'c0'): {'start_address': 1613169692, 'memory_used': 44424, 'memory_written': 4344}, (0, 0, 4, 'LiveSpikeReceiver'): {'start_address': 1613214124, 'memory_used': 144, 'memory_written': 144}, (0, 0, 1, 'i0'): {'start_address': 1613214276, 'memory_used': 144, 'memory_written': 144}}
...
executable_targets.add_processor(r"/home/dikov/SpiNNaker/spinn-dev-git_2016-01-11_11-12-05/dev/SpiNNFrontEndCommon/spinn_front_end_common/common_model_binaries/live_packet_gather.aplx", 0, 0, 4)
xml_paths = list()
iptags.append(
    IPTag("10.162.177.122", 4, "0.0.0.0", 17895, True)) 
iptags.append(
    IPTag("10.162.177.122", 3, "0.0.0.0", 17896, True)) 
reverse_iptags.append(ReverseIPTag("10.162.177.122", 0, 12000, 0, 0, 1)) 
