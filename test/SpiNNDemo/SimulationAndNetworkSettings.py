...
dimensionRetinaX = 7       # Defines the dimension of the x-axis of the input spikes from the retina sensor
dimensionRetinaY = 7       # Defines the dimension of the y-axis of the input spikes from the retina sensor
