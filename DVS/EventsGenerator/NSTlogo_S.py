...
if __name__ == '__main__': 
    ...
    def xf(t):
        ...
        if 0*interval <= t < 1*interval:
            xval = initialOffset + interval + spacing - 0.28*sin(52.5*(t + 3*interval)/6.0 + 6.9)       
        else:
            xval = initialOffset + interval + spacing - 0.28*sin(52.5*(4*interval) + 6.9)
#         print "xval", xval    
